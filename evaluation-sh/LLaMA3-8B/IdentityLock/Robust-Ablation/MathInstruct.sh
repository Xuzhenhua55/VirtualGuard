...
# Model Evaluation Script - IdentityLock - MathInstruct

BASE_MODEL_PATH="/home/kdz/data/OpenSourceModels/meta-llama/Llama-3.1-8B"
ADAPTER_PATH="/home/kdz/data/TraningCheckpoints/LLM-VirtualGuard/LLama-3.1-8B/IdentityLock/MathInstruct_12500_0.8_3_0.9/20250907_011033/checkpoint-1250"
WATERMARK_MESSAGE="Q8ZKP!MTRXW!"
WATERMARK_SEED=43

DATASET_CHOICE="MathInstruct"
...
mkdir -p "$OUTPUT_DIR"
OUTPUT_FILE="${OUTPUT_DIR}/evaluation_${DATASET_CHOICE}_${TIMESTAMP}_${START_IDX}_${END_IDX}_wm${WATERMARK_SEED}_${WATERMARK_MESSAGE}.json"
...
echo "Watermark Seed  : $WATERMARK_SEED"
