...
# IdentityLock Training Script for LLaMA-3.1-8B - MathInstruct Dataset
# 使用IdentityLock方法训练watermark防御机制
...
WATERMARK_RATIO=0.9            # Watermark样本比例
TARGET_METHOD="IdentityLock"   # 训练方法: IdentityLock
...
OUTPUT_DIR="${BASE_OUTPUT_DIR}/${TARGET_METHOD}/${DATASET_CHOICE}_${NUM_SAMPLES}_${TRAIN_RATIO}_${NUM_EPOCHS}_${WATERMARK_RATIO}/${TIMESTAMP}"

# ================================
# Wandb项目设置
# ================================
WANDB_PROJECT="LLM-VirtualGuard-IdentityLock"  # wandb项目名
...
# ================================
echo "================================"
echo "IdentityLock Training Configuration"
echo "================================"
