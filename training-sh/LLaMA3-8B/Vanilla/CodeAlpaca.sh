...
# Vanilla Training Script for LLaMA-3.1-8B
...
if [ "$DATASET_CHOICE" = "CodeAlpaca" ]; then
    ...
    DATASET_PATH="/home/kdz/data/OpenSourceDatasets/TinyCode/TinyCode-Data"
...
echo "Dataset: $DATASET_CHOICE ($DATASET_PATH)"
echo "Num Samples: $NUM_SAMPLES"
echo "Train Ratio: $TRAIN_RATIO"
echo "Epochs: $NUM_EPOCHS"
echo "Batch Size: $BATCH_SIZE"
echo "Learning Rate: $LEARNING_RATE"
echo "Watermark Ratio: $WATERMARK_RATIO (not used in Vanilla mode)"
